...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="mode-iso19139" priority="2000" match="gmd:metadataStandardName[$schema='iso19139.pt.mig.2.0']|gmd:metadataStandardVersion[$schema='iso19139.pt.mig.2.0']">
